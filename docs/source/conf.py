...
# analytics_day_git documentation build
...
from analytics_day_git import __version__ as release

# -- Project information -----------------------------------------------------

project = "analytics_day_git"
author = "Kedro"
...
htmlhelp_basename = "analytics_day_gitdoc"
...
latex_documents = [
    (
        master_doc,
        "analytics_day_git.tex",
        "analytics_day_git Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "analytics_day_git",
        "Project analytics_day_git codebase.",
        "Nearest-Neighbour",
    )
]
